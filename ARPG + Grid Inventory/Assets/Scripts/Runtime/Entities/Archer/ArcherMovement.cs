...
public class ArcherMovement : State
{
    ...
    public ArcherMovement(StateManager stateManager, ArcherController controller) : base(stateManager)
    {
        _zc = controller;
    ...
    public override void Execute()
    {
        ...
        if (_zc.IsTargetVisible()) // SI LO VEO
        {
            ...
            if (Vector3.Distance(_zc.Position, _model.targetData.Position) < _model.data.arrowAttack.range)//  -- Estoy a distancia de atacar del target
            {
        ...
        else
        {
            ...
            _stateManager.SetState<ArcherIdle>(); //Si llegue al final y no lo veo paso a Idle
        }
    }
